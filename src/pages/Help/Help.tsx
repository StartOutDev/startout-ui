...
const Help = () => (
    <Block background="midLightGrey" textColour="darkBlue">
        ...
        <Block display="flex" flexDirection="row">
            <Block display="flex" flexGrow={1} flexWrap="wrap" flexDirection="column">
                <Block maxWidth="100%" flex="0 0 100%" p="1.5rem .35rem" display="flex" flexDirection="column" background="white" >
                ...
                <Block maxWidth="100%" flex="0 0 100%" p="1.5rem .35rem" display="flex" background="palePink">
                    <Block display="flex" textAlign="center" maxWidth="560px" margin="31px">
                        <Heading maxWidth="255px" textSize={1.5}>
            ...
            <Block display="flex" flexGrow={1} flexWrap="wrap" flexDirection="column">
                <Block maxWidth="100%" flex="0 0 100%" p="1.5rem .35rem" display="flex" background="paleBlue" >
                    <Block display="flex" textAlign="center" maxWidth="560px" margin="31px" >
                        <Heading maxWidth="255px" textSize={1.5}>
                            Get Social
                    </Heading>
                ...
                <Block maxWidth="100%" flex="0 0 100%" p="1.5rem .35rem" display="flex" background="white">
                    <Block display="flex" textAlign="center" maxWidth="560px" margin="31px">
                        <Heading maxWidth="255px" textSize={1.5}>
                            Join our eNewsletter
                    </Heading>
        ...
        <Block display="flex" flexDirection="row">
            <Block maxWidth="50%" flex="0 0 50%" p="1.5rem .35rem" display="flex" background="red">
                <Block display="flex" textAlign="center" maxWidth="560px" margin="31px" >
                    <Heading maxWidth="255px" textSize={1.5}>
                        Coming soon
                </Heading>
            ...
            <Block display="flex" flexGrow={1} flexWrap="wrap" flexDirection="column">
                <Block maxWidth="100%" flex="0 0 100%" p="1.5rem .35rem" display="flex" background="green" >
                    <Block display="flex" textAlign="center" maxWidth="560px" margin="31px" >
                        <Heading maxWidth="255px" textSize={1.5}>
                            Get Social
                    </Heading>
                    ...
                    <Block>
                        <svg width="246" height="243" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M18.636 94.5h45.846L53.3 147H0v35.625h45.473L32.8 243h39.136l12.673-60.375h48.827L120.764 243h38.763l12.673-60.375h55.164V147h-47.337l11.182-52.5H246v-36h-47.336L211.336 0h-38.763L159.9 58.5h-48.827L123.745 0H84.609L71.936 58.5h-53.3v36zm84.982 0h48.827L141.264 147H92.436l11.182-52.5z"
                                fill="#fff"
                                fill-opacity=".2" />
                        </svg>
                    </Block>
                </Block>
                <Block maxWidth="100%" flex="0 0 100%" p="1.5rem .35rem" display="flex" background="purple">
                    <Block display="flex" textAlign="center" maxWidth="560px" margin="31px">
                        <Heading maxWidth="255px" textSize={1.5}>
                            Join our eNewsletter
                    </Heading>
                    ...
                    <Block>
                        <svg width="244" height="243" fill="none" xmlns="http://www.w3.org/2000/svg">
